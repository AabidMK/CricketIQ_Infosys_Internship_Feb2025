...
if st.button("📊 View Power BI Report"):
    st.write("Opening Power BI Report...")
    # webbrowser.open_new_tab(power_bi_url)
    power_bi_url = "https://app.powerbi.com/reportEmbed?reportId=a425c2db-7165-4016-8e9c-74fe304d59df&autoAuth=true&ctid=3cb3c705-b71b-48b1-a3b7-13d46af55ff7"
